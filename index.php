...
$options['min_image_width'] = 460;
$options['min_image_height'] = 460;
    ...
    <body>
        ...
        <section>
            ...
            <div class="view-advanced-data">
                <button onclick="document.getElementById('advanced-data').style.display = 'block'; this.style.display = 'none';">More</button>
            </div>
